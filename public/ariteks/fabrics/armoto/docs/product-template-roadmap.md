...
Wygenerowano: 2026-07-10T19:22:35
...
- Strona produktu: https://www.ariteks.net/armoto.asp
- Publiczny manifest JSON: `/ariteks/fabrics/armoto/data/fabric-complete-record.json`
- Folder public: `E:\ariteks\new\sport\public\ariteks\fabrics\armoto`

## 1. Dane ze strony zbiorczej kategorii

- Grupa: **Heavy Warp Knit Fabrics for Shoes and Wind Jackets**
- Nazwa w tabeli kategorii: **ArMoto**
- Wiersz tabeli: `92`
- Tekst wiersza: 240 g/m² 100% PES ArMoto ArMoto Warp Knit Wind Heavy Warp Knit Fabrics for Shoes and Wind Jackets Interlock 170 g/m² 100% PES ArSport X Bird Eye Heavy Warp Knit Fabrics for Shoes and Wind Jackets ArSport ArSport X Heavy Warp Knit Fabrics for Shoes and Wind Jackets
...
- [https://www.ariteks.net/pdf/ArMoto_ru_ds_ver2.pdf](/ariteks/fabrics/armoto/documents/armoto-ru-ds-ver2__eab0490475.pdf)
  - Public: `/ariteks/fabrics/armoto/documents/armoto-ru-ds-ver2__eab0490475.pdf`
...
- EN 20471
  - Public: `/ariteks/fabrics/armoto/images/en-20471__b3c86afe25.jpg`

### 1.5. Struktura / splot z wiersza kategorii

- Nazwa splotu: `Warp Knit`
- Grafika struktury: `/ariteks/fabrics/armoto/images/warp-knit__22376b13e5.jpg`
...
- Opis z title: `Fabric for Shoes and Office Upholstery`
- Linia specyfikacji: `240 g/m², 100% Polyester, Wind Jacket Fabric`

### 2.1. Hero / duże zdjęcie

- Fabric for Shoes and Office Upholstery
  - Public: `/ariteks/fabrics/armoto/images/armoto-main-pic-m__080a5683d1.jpg`

### 2.2. Opis

- %100 polyester wind jacket fabric
- ArMoto can be used on motorcyclist cloths as air channel.
- For the shoes industry it is popular fabric to laminate on base and edge of sport shoes.
...
| Bursting strength | > 2500 kPa (kN/m² ) | TS EN 13938-1 |
...
| Application | Wind Jacket, Shoes |  |
| Quality Management | Done | ISO 9001 |

### 2.4. Technical Documents

- [>> ArMoto Data Sheet](/ariteks/fabrics/armoto/documents/armoto-ds__6221b17677.pdf)
  - Public: `/ariteks/fabrics/armoto/documents/armoto-ds__6221b17677.pdf`
...
- Oeko Tex Standard 100
  - Public: `/ariteks/fabrics/armoto/images/oekoteks-standard-100-s__ea5e91d474.jpg`

### 2.8. Care Instructions

- 60'C Machine Wash
  - Public: `/ariteks/fabrics/armoto/images/60-mach-wash-ma-agi__cdc86ecf03.jpg`
- No Chlorine Based Bleaching
  - Public: `/ariteks/fabrics/armoto/images/no-chlorine-bleach__33a0308671.jpg`
- Can Be Tumble Dried On Low Heat Setting
  - Public: `/ariteks/fabrics/armoto/images/tumble-dried-low-ht__cd432a52a7.jpg`
- Maximum 150'C Warm Iron
  - Public: `/ariteks/fabrics/armoto/images/ma-150-iron__78883199be.jpg`
- Suitable for Dry Cleaning
  - Public: `/ariteks/fabrics/armoto/images/dry-cleaning__6e8a85520f.jpg`

### 2.9. Colors and Article Numbers

| Kolor | Kod / PIND / PT | Wykończenie | Numer artykułu |
|---|---|---|---|
| Navy | PT-57753-1 | - STANDARD - | ArMoto-4349 |
| Black | PT-95503 | - STANDARD - | ArMoto-4350 |
...
```text
Fabric for Shoes and Office Upholstery - ArMoto - Ariteks
